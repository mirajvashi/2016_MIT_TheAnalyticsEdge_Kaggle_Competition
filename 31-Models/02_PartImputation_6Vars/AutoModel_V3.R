...
## BUILDING MODEL ONLY BASED ON HIGH SIGNIFICANCE VARIABLES + YOB !
...
for (i in 1:length(SplRatio))
{
    ...
    glmModel = glm(Party ~ YOB + Gender + Income + HouseholdStatus + EducationLevel + Q123464 + Q123621 + Q116953 + Q115611 + Q115899 + Q114961 + Q114152 + Q109244 + Q100562, data = dfTrain, family = "binomial")
    cartModel = rpart(Party ~ YOB + Gender + Income + HouseholdStatus + EducationLevel + Q123464 + Q123621 + Q116953 + Q115611 + Q115899 + Q114961 + Q114152 + Q109244 + Q100562, data = dfTrain, method = "class")
    rfModel = randomForest(Party ~ YOB + Gender + Income + HouseholdStatus + EducationLevel + Q123464 + Q123621 + Q116953 + Q115611 + Q115899 + Q114961 + Q114152 + Q109244 + Q100562, data = dfTrain)
...
## WRITE THE OUTPUT TO CSV FILE
    write.csv(dfOutput, "AutoModel_V3_Output.csv", row.names = FALSE)
}