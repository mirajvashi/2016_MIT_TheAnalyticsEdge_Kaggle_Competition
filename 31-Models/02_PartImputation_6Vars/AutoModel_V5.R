...
for (i in 1:length(SplRatio))
{
    ...
    glmModel = glm(Party ~ HouseholdStatus + Q115611 + Q109244, data = dfTrain, family = "binomial")
    cartModel = rpart(Party ~ HouseholdStatus + Q115611 + Q109244, data = dfTrain, method = "class")
    rfModel = randomForest(Party ~ Gender + Income + HouseholdStatus + Q115611 + Q109244, data = dfTrain)
...
## WRITE THE OUTPUT TO CSV FILE
    write.csv(dfOutput, "AutoModel_V5_Output.csv", row.names = FALSE)
}