...
## BUILDING MODEL ONLY BASED ON HIGH SIGNIFICANCE VARIABLES !
...
for (i in 1:length(SplRatio))
{
    ...
    glmModel = glm(Party ~ Gender + Income + HouseholdStatus + EducationLevel + Q123464 + Q123621 + Q116953 + Q115611 + Q115899 + Q114961 + Q114152 + Q109244 + Q100562, data = dfTrain, family = "binomial")
    cartModel = rpart(Party ~ Gender + Income + HouseholdStatus + EducationLevel + Q123464 + Q123621 + Q116953 + Q115611 + Q115899 + Q114961 + Q114152 + Q109244 + Q100562, data = dfTrain, method = "class")
    rfModel = randomForest(Party ~ Gender + Income + HouseholdStatus + EducationLevel + Q123464 + Q123621 + Q116953 + Q115611 + Q115899 + Q114961 + Q114152 + Q109244 + Q100562, data = dfTrain)
...
## WRITE THE OUTPUT TO CSV FILE
    write.csv(dfOutput, "AutoModel_V2_Output.csv", row.names = FALSE)
}