...
for (i in 1:length(SplRatio))
{
    ...
    glmModel = glm(Party ~ Q109244 + Q113181 + Q98197 + Q98869 + Q121700 + Q98078, data = dfTrain, family = "binomial")
    cartModel = rpart(Party ~ Q109244 + Q113181 + Q98197 + Q98869 + Q121700 + Q98078, data = dfTrain, method = "class")
    rfModel = randomForest(Party ~ Q109244 + Q113181 + Q98197 + Q98869 + Q121700 + Q98078, data = dfTrain, ntree = 500)
