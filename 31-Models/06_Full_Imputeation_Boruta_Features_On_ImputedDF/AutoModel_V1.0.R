...
for (i in 1:length(SplRatio))
{
    ...
    cartModel = rpart(Party ~ Gender + Q120379 + Q115611 + Q113181 + Q109244 + Q98869 + Q98197, data = dfTrain, method = "class")
    rfModel = randomForest(Party ~ Gender + Q120379 + Q115611 + Q113181 + Q109244 + Q98869 + Q98197, data = dfTrain)
